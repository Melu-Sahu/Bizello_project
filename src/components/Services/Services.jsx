...
const Services = () => {
    return (
        <div id='services' className='bg-gray-200 w-full  lg:px-10 py-3  lg:flex sm:block justify-center items-center'>
            ...
            <div className='lg:w-2/5 sm:w-full lg:my-3 sm:my-12  ms-7'>
                ...
                <h1 className='text-violet-800 lg:my-5 sm:my-3 sm:py-3 font-bold '>OUR SERVICEES</h1>
